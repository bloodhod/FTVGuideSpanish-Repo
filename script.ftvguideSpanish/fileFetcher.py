...
class FileFetcher(object):
    ...
    basePath = xbmc.translatePath(os.path.join('special://profile', 'addon_data', 'script.ftvguideSpanishSpanishSpanish'))
    filePath = ''
    fileUrl = ''
    addon = None
    ...
    def fetchFile(self):
        ...
        if fetch:
            ...
            if os.path.getsize(tmpFile) > 256:
                ...
                xbmc.log('[script.ftvguideSpanishSpanishSpanish] file %s was downloaded' % self.filePath, xbmc.LOGDEBUG)
            else:
